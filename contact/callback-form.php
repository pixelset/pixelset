...
$use_smtp = '0';
$emailto = 'write@pixelset.ru';

	// retrieve from parameters
	$emailfrom = isset($_POST["callback-phone"]) ? $_POST["callback-phone"] : "";
	$nocomment = ''; //isset($_POST["nocomment"]) ? $_POST["nocomment"] : "";
	$subject = 'Письмо от PixelSet (форма звонка)';
	$message = '';
	$response = '';
...
function sendEmail($subject, $content, $emailto, $emailfrom) {
	...
	$response_error = 'Что-то пошно не так. Попробуйте еще-раз.';
