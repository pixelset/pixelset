...
$(document).ready(function(){ 
    // menuHandler();
    $('#tiny, #marketFeatures, #sitesFeatures, #bannersFeatures, #helpMoreButton, #tiny2').localScroll({
	    offset: {top:0, left:0}
    });
  });  
/*-----------------------------------------------------------------------------------*/
	...
	if( $('.forms').length>0 ) {
		...
		$('textarea' ,$form).each(function(){
			...
			if(getParameterByName('message')) {
				$(fields['message']).val( getParameterByName('message') );
			}
		})
	}
});
...
function showMarketTab(num) {
	var tabName = '#tab-' + num;
	$('.tabs').easytabs('select', tabName);
}
/*-----------------------------------------------------------------------------------*/
/*	TESTIMONIALS
/*-----------------------------------------------------------------------------------*/  
...
/*-----------------------------------------------------------------------------------*/
function gotoSites() {
	window.location.href = "index2.html#market";
}
function gotoBanners() {
	window.location.href = "index2.html#banners";
}
function gotoHelp() {
	window.location.href = "index2.html#help";	
}
/*-----------------------------------------------------------------------------------*/
/*	UTILS
/*-----------------------------------------------------------------------------------*/
